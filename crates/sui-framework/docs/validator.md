...
<pre><code><b>fun</b> <a href="validator.md#0x2_validator_verify_proof_of_possession">verify_proof_of_possession</a>(
    ...
    // The first three bytes represents the intent IntentVersion::V0, AppId::Sui, IntentScope::ProofOfPossession. See `intent.rs` for details.
    <b>let</b> signed_bytes: <a href="">vector</a>&lt;u8&gt; = <a href="">vector</a>[6, 0, 0, 120];
